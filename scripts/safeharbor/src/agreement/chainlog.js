...
export function createChainlogReader(provider) {
    const chainlogInstance = new Contract(CHAINLOG_ADDRESS, CHAINLOG_ABI, provider);
    return async function getChainlogAddress(key) {
