...
- Colocated `src/cli.test.js` and `src/sheet.test.js` check pure command and header diagnostic results; `src/formatDiagnostic.test.js` checks human-readable wording independently of detection.
