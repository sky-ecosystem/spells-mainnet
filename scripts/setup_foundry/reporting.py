...
def report_verification_summary(
    ...
    print("\nEvidence summary:")
    print(
        f"  Source: spells-mainnet {source_commit}; setup tooling SHA-256 {tooling_hash}"
    )
    print(
        f"  Eligible release: {selection['version']}; {selection['published_at']}; {selection['release_url']}"
    )
