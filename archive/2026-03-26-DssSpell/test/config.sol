...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x415396C98A5B42C0D97E4E80cB5C9079369Ea4D8), // populate with deployed spell if deployed
            deployed_spell_created: 1774447103,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   24735013,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
        ...
        afterSpell.chainlog_version       = "1.20.14";                                    // String expected in system
