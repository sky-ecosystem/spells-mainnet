...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x396122c087Aa23BeE53B38e14237B3C0C10DdDbc), // populate with deployed spell if deployed
            deployed_spell_created: 1773323267,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   24641780,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
