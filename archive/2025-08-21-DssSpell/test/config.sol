...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x3F89feDD7588456e44189A36fD888c56B2C1f589), // populate with deployed spell if deployed
            deployed_spell_created: 1755786071, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   23190018,   // use `make deploy-info tx=<deployment-tx>` to obtain the block number
