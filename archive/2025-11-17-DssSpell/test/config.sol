...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x2140f15f957Fcb0b101CD3957217174c3E4d6bf9), // populate with deployed spell if deployed
            deployed_spell_created: 1763130335,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   23798011,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
