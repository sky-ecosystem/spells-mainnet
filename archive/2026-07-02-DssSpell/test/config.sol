...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0xEbf156fB6C87cBE0a962944eC254b519c1441A51), // populate with deployed spell if deployed
            deployed_spell_created: 1782995903,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   25444877,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
