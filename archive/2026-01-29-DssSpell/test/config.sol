...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x4d99868F6D4d2545EbFf3a1385efE31C06d3A472), // populate with deployed spell if deployed
            deployed_spell_created: 1769611979, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   24334060,   // use `make deploy-info tx=<deployment-tx>` to obtain the block number
