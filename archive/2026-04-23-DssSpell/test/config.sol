...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x06851b5235Cefb29C60EF3b29EB1f661D960B125), // populate with deployed spell if deployed
            deployed_spell_created: 1776957287,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   24943476,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
