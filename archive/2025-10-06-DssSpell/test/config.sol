...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x0727FFA3221a8D3cDaAaBc7d19Ed0583847496e1), // populate with deployed spell if deployed
            deployed_spell_created: 1759770779,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   23520141,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
