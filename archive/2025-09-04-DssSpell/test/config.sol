...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x1832dF0fF2bf73A182e09966166BEC6C4ed0b69b), // populate with deployed spell if deployed
            deployed_spell_created: 1757092151, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   23298302,   // use `make deploy-info tx=<deployment-tx>` to obtain the block number
