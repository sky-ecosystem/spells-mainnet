...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x0D2BDA9a446527238E802708B370DD66f375E4d1), // populate with deployed spell if deployed
            deployed_spell_created: 1765453619, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   23989229,   // use `make deploy-info tx=<deployment-tx>` to obtain the block number
