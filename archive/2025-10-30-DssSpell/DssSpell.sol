...
import { TreasuryFundedFarmingInit, FarmingInitParams } from "src/dependencies/endgame-toolkit/treasury-funded-farms/TreasuryFundedFarmingInit.sol";
...
contract DssSpellAction is DssAction {
    ...
    function actions() public override {
        ...
        DssCronSequencerLike(CRON_SEQUENCER).addJob(CRON_STARGUARD_JOB);

        // Add SPARK_STARGUARD to the StarGuardJob
        StarGuardJobLike(CRON_STARGUARD_JOB).add(SPARK_STARGUARD);

        // Add StarGuardJob to the Chainlog as CRON_STARGUARD_JOB
        DssExecLib.setChangelogAddress("CRON_STARGUARD_JOB", CRON_STARGUARD_JOB);
