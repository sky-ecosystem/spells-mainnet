...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0xa1D35e93d5BfAF300e0327d73143529f19B3DA78), // populate with deployed spell if deployed
            deployed_spell_created: 1761857135,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   23692666,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
