...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x26009aFf7fE39bF7611d66E0D38CAc43b3A93CD5), // populate with deployed spell if deployed
            deployed_spell_created: 1754507111, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   23084000,   // use `make deploy-info tx=<deployment-tx>` to obtain the block number
