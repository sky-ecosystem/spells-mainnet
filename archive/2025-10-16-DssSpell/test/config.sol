...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0xf3d37a2508d269b8328026f72D65795730Ce07b6), // populate with deployed spell if deployed
            deployed_spell_created: 1760607779,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   23589405,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
