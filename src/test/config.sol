...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0xed3de16bDF69F697FecF1b4103b9f48d71BdDF20), // populate with deployed spell if deployed
            deployed_spell_created: 1763049323,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   23791312,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
