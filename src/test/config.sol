...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x86d6CdD0D259AAAfb8134D47464b77743F50380B), // populate with deployed spell if deployed
            deployed_spell_created: 1789044515, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   25947089,   // use `make deploy-info tx=<deployment-tx>` to obtain the block number
