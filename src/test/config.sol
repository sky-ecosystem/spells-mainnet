...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0xe1F50bEBe18C57B3060FBeE21d48693764aFa6ff), // populate with deployed spell if deployed
            deployed_spell_created: 1776930623,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   24941259,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
