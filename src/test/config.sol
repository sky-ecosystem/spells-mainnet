...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0xA0059DaDd7Fbdbc81a9bb9d1d17cCB029b6AF596), // populate with deployed spell if deployed
            deployed_spell_created: 1778166215,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   25043934,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
        ...
        //
        afterSpell.max_global_line_offset = 700 * MILLION;                                // Offset between the global line against the sum of local lines, after external line increases
        ...
        afterSpell.collaterals["ALLOCATOR-INTERVAL-A"] = CollateralValues({
            um:           UpdateMethod.AUTOLINE,
            aL_line:      10_000_000,
            aL_gap:       10_000_000,
            aL_ttl:       86_400,
