...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x4C56b1B1554B1230349d66F665814641A609C569), // populate with deployed spell if deployed
            deployed_spell_created: 1772101535, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   24540480,   // use `make deploy-info tx=<deployment-tx>` to obtain the block number
