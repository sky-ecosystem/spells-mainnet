...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x97bD98F46D0d0769745883E76c05483f9aa15Ca6), // populate with deployed spell if deployed
            deployed_spell_created: 1770824567, // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   24434498,   // use `make deploy-info tx=<deployment-tx>` to obtain the block number
