...
contract Config {
    ...
    function setValues() public {
        ...
        //
        spellValues = SpellValues({
            deployed_spell:         address(0x70Da14478667C08320Ef65506063abba84B6990f), // populate with deployed spell if deployed
            deployed_spell_created: 1775822267,          // use `make deploy-info tx=<deployment-tx>` to obtain the timestamp
            deployed_spell_block:   24849172,          // use `make deploy-info tx=<deployment-tx>` to obtain the block number
