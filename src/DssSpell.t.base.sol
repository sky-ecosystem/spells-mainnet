...
contract DssSpellTestBase is Config, DssTest {
    ...
    function _checkTransferrableVestAllowanceAndBalance(
        ...
        if (address(_gem) != address(sky)) {
            ...
            // TODO: Restore 14 days to 20 days after the 2026-09-24 Spell; This value was only temporarily reduced
            ...
            // Note: SKY streams will operate out of buybacks, check that balance is sufficient for short term (14 days)
            ...
            // TODO: Restore 14 days to 20 days after the 2026-09-24 Spell
            assertGe(_gem.balanceOf(pauseProxy), requiredBalance, _concat(string("TestError/insufficient-transferrable-vest-balance-for-14-days-"), _errSuffix));
        }
    }
